...
#Compare dS and dN between endotherms and ectotherms
wilcox.test(dS ~ ThermoMode, data = molrate)
wilcox.test(dN ~ ThermoMode, data = molrate)
...
plot_groups <- c("Birds","Mammals","Reptiles", "Amphibians","Fishes")
